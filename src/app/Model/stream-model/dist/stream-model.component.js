...
exports.StreamModelComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var dialog_1 = require("@angular/material/dialog");
var jwt_decode_1 = require("jwt-decode");
var sweetalert2_1 = require("sweetalert2");
var StreamModelComponent = /** @class */ (function () {
    function StreamModelComponent(formbuilder, dialog, editData, api) {
        this.formbuilder = formbuilder;
        this.dialog = dialog;
        this.editData = editData;
        this.api = api;
        this.Submit = 'Add Stream';
    }
    StreamModelComponent.prototype.ngOnInit = function () {
    ...
    StreamModelComponent.prototype.addStream = function () {
        var _this = this;
        if (!this.editData) {
            if (this.streamForm.value.qualification_name == '' || this.streamForm.value.stream == '') {
                ...
                this.api.addStream(this.streamForm.value).subscribe({
                    next: function (res) {
                        ...
                        //   // })
                        // }
                        sweetalert2_1["default"].fire('Good job!', 'Stream Added Successfully', 'success');
                        _this.streamForm.reset();
    ...
    StreamModelComponent.prototype.AllQualification = function () {
        var _this = this;
    ...
    StreamModelComponent.prototype.updateStream = function () {
        var _this = this;
        this.api.updateStream(this.editData._id, this.streamForm.value).subscribe({
            next: function (res) {
                sweetalert2_1["default"].fire('Good job!', 'Stream Updated Successfully', 'success');
                _this.streamForm.reset();
    ...
    StreamModelComponent = __decorate([
        core_1.Component({
    ...
    return StreamModelComponent;
}());
exports.StreamModelComponent = StreamModelComponent;
