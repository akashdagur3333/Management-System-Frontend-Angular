...
exports.TrainingsComponent = void 0;
...
var TrainingsComponent = /** @class */ (function () {
    function TrainingsComponent(dialog, api) {
        this.dialog = dialog;
        this.api = api;
        this.displayedColumns = ['id', 'txn_id', 'rpt_id', 'type', 'name', 'sex', 'txnStart', 'txnEnd', 'jobStatus', 'action'];
    }
    TrainingsComponent.prototype.ngOnInit = function () {
        this.getAllReporting();
    };
    TrainingsComponent.prototype.applyFilter = function (event) {
    ...
    TrainingsComponent.prototype.getAllReporting = function () {
        var _this = this;
    ...
    ], TrainingsComponent.prototype, "paginator");
    __decorate([
        core_1.ViewChild(sort_1.MatSort)
    ], TrainingsComponent.prototype, "sort");
