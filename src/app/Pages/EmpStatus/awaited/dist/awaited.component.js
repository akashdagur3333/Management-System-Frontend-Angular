...
exports.AwaitedComponent = void 0;
...
var AwaitedComponent = /** @class */ (function () {
    function AwaitedComponent(dialog, api) {
        this.dialog = dialog;
        this.api = api;
    ...
    AwaitedComponent.prototype.applyFilter = function (event) {
    ...
    AwaitedComponent.prototype.getAllReporting = function () {
        var _this = this;
    ...
    ], AwaitedComponent.prototype, "paginator");
    __decorate([
        core_1.ViewChild(sort_1.MatSort)
    ], AwaitedComponent.prototype, "sort");
    AwaitedComponent = __decorate([
        core_1.Component({
